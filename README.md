![Alt text](./resources/eacs.png "ESP32-EACS")
...
(under _eacs_hardware_), as well as the required software (under _eacs_software_). Note that due to the RC522 development board used, the current device works only with cards operating at 13.56MHz.
